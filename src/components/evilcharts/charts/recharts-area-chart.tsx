 ...
 */
function Tooltip({ variant, roundness, defaultIndex, formatter, cursor = true }: TooltipProps) {
  ...
  return (
    <ChartTooltip
      ...
      content={
        <ChartTooltipContent selected={selectedDataKey} roundness={roundness} variant={variant} formatter={formatter} />
      }
    />
  );
}
